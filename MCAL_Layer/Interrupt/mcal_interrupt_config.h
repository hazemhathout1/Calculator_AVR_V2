...
#ifndef MCAL_LAYER_INTERRUPT_MCAL_INTERRUPT_CONFIG_H_
#define MCAL_LAYER_INTERRUPT_MCAL_INTERRUPT_CONFIG_H_
/*---------------------------INCLUDES------------------------*/
#include "../01-GPIO/MCAL_GPIO.h"
#include "../01-GPIO/include/avr/interrupt.h"
...
#define INTERRUPT_GlobalInterruptDisable()	(CLR_BIT(SREG,SREG_I))
...
#endif /* MCAL_LAYER_INTERRUPT_MCAL_INTERRUPT_CONFIG_H_ */
