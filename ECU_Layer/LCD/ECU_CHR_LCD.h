...
#ifndef ECU_LAYER_LCD_ECU_CHR_LCD_H_
#define ECU_LAYER_LCD_ECU_CHR_LCD_H_


/*---------------------------INCLUDES------------------------*/
#include "../../MCAL_Layer/01-GPIO/MCAL_GPIO.h"
#include "ECU_CHR_LCD_CNFG.h"
...
#define _LCD_CURSER_OFF_DISPLAY_ON				 	0x0C
#define _LCD_CURSER_OFF_DISPLAY_OFF				 	0x08
...
#endif /* ECU_LAYER_LCD_ECU_CHR_LCD_H_ */
